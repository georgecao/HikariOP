...
import static org.reploop.hikari.pool.PoolEntry.LASTACCESS_COMPARABLE;
...
import static org.reploop.hikari.util.ConcurrentBag.IConcurrentBagEntry.STATE_REMOVED;
...
public class HikariPool extends PoolBase implements HikariPoolMXBean, IBagStateListener
{
   ...
   private final long ALIVE_BYPASS_WINDOW_MS = Long.getLong("com.reploop.hikari.aliveBypassWindowMs", MILLISECONDS.toMillis(500));
   private final long HOUSEKEEPING_PERIOD_MS = Long.getLong("com.reploop.hikari.housekeeping.periodMs", SECONDS.toMillis(30));
