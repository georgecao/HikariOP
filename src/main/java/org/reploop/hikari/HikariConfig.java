...
import static org.reploop.hikari.util.UtilityElf.getNullIfEmpty;
   ...
   private String generatePoolName() {
      ...
      try {
         ...
         synchronized (System.getProperties()) {
            final String next = String.valueOf(Integer.getInteger("org.reploop.hikari.pool_number", 0) + 1);
            System.setProperty("org.reploop.hikari.pool_number", next);
            return prefix + next;
         }
