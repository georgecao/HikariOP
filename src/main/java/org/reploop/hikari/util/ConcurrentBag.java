...
public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable
{
   ...
   {
      try {
         if (System.getProperty("com.reploop.hikari.useWeakReferences") != null) {   // undocumented manual override of WeakReference behavior
            return Boolean.getBoolean("com.reploop.hikari.useWeakReferences");
         }
