...
public final class JavassistProxyFactory
{
   ...
   {
      System.out.println("Generating method bodies for com.reploop.hikari.proxy.ProxyFactory");

      String packageName = ProxyConnection.class.getPackage().getName();
      CtClass proxyCt = classPool.getCtClass("com.reploop.hikari.pool.ProxyFactory");
